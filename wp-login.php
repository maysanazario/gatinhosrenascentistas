...
<html lang="pt-BR">
	...
	<title>Acessar &lsaquo; Elegância Felina na Arte e na História &#8212; WordPress</title>
		...
		<form name="loginform" id="loginform" action="http://localhost/wordpress/wp-login.php" method="post">
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Acessar">
					...
					<p id="nav">
				<a href="./?action=lostpassword">Perdeu a senha?</a>			</p>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Ir para Elegância Felina na Arte e na História</a>		</p>
			</div>
...
/* <![CDATA[ */
var userProfileL10n = {"user_id":"0","nonce":"deb1bb5835"};
/* ]]> */
</script>
